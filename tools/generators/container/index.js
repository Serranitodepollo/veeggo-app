...
module.exports = {
  ...
  actions: (data) => {
    ...
    if (data.wantActionsAndReducer) {
      ...
      actions.push({
        type: 'add',
        path: '../../src/generators/{{properCase name}}/actions.js',
        templateFile: './container/actions.js.hbs',
        abortOnFail: true,
      });
      actions.push({
        type: 'add',
        path: '../../src/generators/{{properCase name}}/tests/actions.test.js',
      ...
      actions.push({
        type: 'add',
        path: '../../src/generators/{{properCase name}}/constants.js',
      ...
      actions.push({
        type: 'add',
        path: '../../src/generators/{{properCase name}}/selectors.js',
        templateFile: './container/selectors.js.hbs',
        abortOnFail: true,
      });
      actions.push({
        type: 'add',
        path: '../../src/generators/{{properCase name}}/tests/selectors.test.js',
      ...
      actions.push({
        type: 'add',
        path: '../../src/generators/{{properCase name}}/reducer.js',
        templateFile: './container/reducer.js.hbs',
        abortOnFail: true,
      });
      actions.push({
        type: 'add',
        path: '../../src/generators/{{properCase name}}/tests/reducer.test.js',
    ...
    if (data.wantSaga) {
      actions.push({
        type: 'add',
        path: '../../src/generators/{{properCase name}}/saga.js',
        templateFile: './container/saga.js.hbs',
        abortOnFail: true,
      });
      actions.push({
        type: 'add',
        path: '../../src/generators/{{properCase name}}/tests/saga.test.js',
