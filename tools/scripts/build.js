...
const { measureFileSizesBeforeBuild, printFileSizesAfterBuild } = require('./helpers/fileSizeReporter');
const printBuildError = require('./helpers/printBuildError');
...
measureFileSizesBeforeBuild(path.resolve(process.cwd(), 'build'))
